    ...
    <main>
        <div class="contenitore-main">
            ...
            <div class="contenuto-main">
                ...
                <!-- v-for="n in 12" :key="n" per creare 12 box vuoti e testare se tutto è ok -->
                <!-- <div class="banner" v-for="(comic, index) in comics" :key="index">
...
import ListaComics from './partials/ListaComics.vue';
...
<style scoped lang="scss">
    ...
    .contenitore-main{
        width: 100%; 
        background-color: $coloreBackgroundScuro;
        position: relative;
